  ...
  return (
    <div className="app-shell">
      ...
      <main className="main">
        ...
        {screen === 'receipts' ? <ReceiptsPanel receipts={state.receipts} onAdd={addReceipt} suppliersById={suppliersById} /> : null}
...
function ReceiptsPanel({ receipts, onAdd, suppliersById }) {
